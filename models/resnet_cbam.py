...
class SiameseResentCBAM(nn.Module):
    def __init__(self, img_dim=1, **kwargs):
        super().__init__()
        self.cnn_block =  nn.Sequential(*list(ResNet(BasicBlock, [2, 2, 2, 2], **kwargs).children()))
